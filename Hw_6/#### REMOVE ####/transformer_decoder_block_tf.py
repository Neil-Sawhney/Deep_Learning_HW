class TransformerDecoderBlock(tf.keras.layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self.self_attention = attention.CachedAttention(
            ...
            kernel_initializer=tf_utils.clone_initializer(self._attention_initializer),
        ...
        self.self_attention_dropout = tf.keras.layers.Dropout(rate=self.dropout_rate)
        ...
        self.encdec_attention_dropout = tf.keras.layers.Dropout(rate=self.dropout_rate)
    ...
    def call(self, inputs, cache=None, decode_loop_step=None):
        ...
        cross_attn_inputs = dict(
            query=self_attention_output, value=memory, attention_mask=attention_mask
        )
        if self.multi_channel_cross_attention:
